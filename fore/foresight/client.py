...
class Foresight:
    ...
    def log(self, query: str, llm_response: str, contexts: list[str]) -> None:
        ...
        Args:
            ...
            llm_response: The response generated by the llm against the query.
            contexts: List of contexts relevant to the query.
        """
        inference_output = InferenceOutput(
            generated_response=llm_response, contexts=contexts)
